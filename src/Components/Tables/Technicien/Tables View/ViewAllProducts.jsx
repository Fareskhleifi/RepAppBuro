...
const ViewAllProducts = () => {
  ...
  const [selectedPart, setSelectedPart] = useState({ name: '', category: '', reference: '' });
              ...
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                { role === "DIRECTION" ? (
                   <td className="px-6 py-4 text-center">
                      <button className="text-blue-600 text-sm  p-1 px-2 rounded-lg hover:text-blue-900  transition duration-300">
                        Consulter
                      </button>
                  </td>
                ) : (
