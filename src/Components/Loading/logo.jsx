  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <span className="bottom-text">RepAppBuro</span>
      </div>
    </StyledWrapper>
  );
}
...
@keyframes trail {
  0% {
    background: linear-gradient(90deg, rgba(70, 130, 180, 0) 90%, rgb(70, 130, 180) 100%);
    opacity: 0;
  }

  30% {
    background: linear-gradient(90deg, rgba(70, 130, 180, 0) 70%, rgb(70, 130, 180) 100%);
    opacity: 1;
  }
